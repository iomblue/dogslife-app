...
const PlaydateCard: React.FC<PlaydateCardProps> = ({ profile, onLike, onPass, onShowOwner }) => {
    return (
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden relative border h-full flex flex-col">
