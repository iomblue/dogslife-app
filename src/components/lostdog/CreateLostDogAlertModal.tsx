...
interface CreateLostDogAlertModalProps {
    dogProfile: DogProfile;
    onClose: () => void;
    onCreate: (alertData: Omit<LostDogAlert, 'id'>) => void;
}

const CreateLostDogAlertModal: React.FC<CreateLostDogAlertModalProps> = ({ dogProfile, onClose, onCreate }) => {
...
export default CreateLostDogAlertModal;
