...
import AlertsMapView from '../lostdog/AlertsMapView';
import AlertListItem from '../lostdog/AlertListItem';
import CreateAlertModal from '../lostdog/CreateAlertModal';
    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-12">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-6">
                    <AlertsMapView alerts={alerts.filter(a => a.status === 'active')} />
                </div>
                ...
                <div className="space-y-4">
                    {alerts.length > 0 ? (
                        alerts
                            ...
                            .map(alert => (
                           <AlertListItem key={alert.id} alert={alert} onMarkAsFound={handleResolveAlert} />
                        ))
                    ) : (
